...
class GorillaExamPage(BaseWebPage):
    ...
    QUESTION_ELEMENT = WebElementObject((By.CSS_SELECTOR, 'p strong'))
    ANSWERS_ELEMENT = WebElementObject((By.CSS_SELECTOR, 'app-tgo-choice tgo-quill-view'))
    ANSWERED_ITEM_ELEMENT = WebElementObject((By.XPATH, '//div[@class="tgo-choice tgo-choice--selected"]'))
