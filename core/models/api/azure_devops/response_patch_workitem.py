...
class ResponsePatchWorkitem:
    ...
    def from_dict(cls, data: Dict[str, Any]):
        ...
        commentVersionRef = data.get("commentVersionRef")
        ...
        return cls(
            ...
            fields=Fields(
                ...
                System_AssignedTo=AssignedTo(
                    displayName=fields_data.get("System.AssignedTo").get("displayName"),
                    url=fields_data.get("System.AssignedTo").get("url"),
                    links=AvatarLink(
                        href=fields_data.get("System.AssignedTo").get("_links").get("avatar").get("href")
                    ),
                    id = fields_data.get("System.AssignedTo").get("id"),
                    uniqueName = fields_data.get("System.AssignedTo").get("uniqueName"),
                    imageUrl = fields_data.get("System.AssignedTo").get("imageUrl"),
                    descriptor = fields_data.get("System.AssignedTo").get("descriptor")
                ),
            ...
            commentVersionRef=CommentVersionRef(
                commentId=commentVersionRef.get("commentId"),
                version=commentVersionRef.get("version"),
                url=commentVersionRef.get("url")
            ),
            links=Links(
