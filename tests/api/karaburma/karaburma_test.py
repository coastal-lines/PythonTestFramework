...
def test_image_file_contains_any_button(karaburma_file_mode_buttons_only_response):
    result = json_helper.convert_text_into_dictonary(karaburma_file_mode_buttons_only_response.text)
...
def test_image_file_validate_schema_response(karaburma_file_mode_buttons_only_response):
    response_json = json_helper.convert_text_into_dictonary(karaburma_file_mode_buttons_only_response.text)
